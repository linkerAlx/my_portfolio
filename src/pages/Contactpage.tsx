    ...
    <div>
      <div className="bg-slate-800 bg-cover bg-center flex flex-col  py-4 min-h-screen lg:w-[1000px} ">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-10">
          <Navbar />
          <div className="bg-white place-self-center lg:w-[1000px] w-11/12 flex  flex-col lg:flex-row p-7 gap-3 min-h-[400px] rounded-xl">
            <div className="mx-auto font-medium">
              ...
              <p className="flex">
                <MdCall size={30} className="text-green-400" />
                :+250 783 653 651
              </p>
              <div>
                <img
                  src={LinkerImage}
                  alt="contactimage"
                  className="w-max-full h-auto w-full"
                />
              </div>
            </div>
            <div className="lg:mt-14">
              <h1 className="text-4xl font-bold mb-6">
                Connect <span className="text-blue-400">Me</span>
              </h1>
              <form className="bg-gray-300 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-lg">
                ...
                ></textarea>
                <br />
                <button className="bg-blue-400 rounded-lg p-2 font-extrabold  lg:mx-20">
                  Send
                </button>
              </form>
            </div>
