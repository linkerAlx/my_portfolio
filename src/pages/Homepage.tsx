...
const Homepage:React.FC = () => {
  return (
    <div className= 'bg-slate-800 bg-cover bg-center flex flex-col  p-4 min-h-screen lg:w-[1000px} '>
        ...
        <div className=' m-auto lg:text-xl font-serif'>
          <h1 className='font-bold '>I'm  INEZA LINKER Arlene; </h1>
          <h2 className='font-bold mb-2'>Front-end developer and UI/UX Designer.</h2>
          <p> I have dedicated my life to mastering cutting-edge technologies to create visually stunning and highly responsive web applications. Explore my projects to see how I transform ideas into interactive digital solutions.</p>
        ...
        <div className='m-auto bg-gray-800 pt-8  pb-4 rounded-t-lg object-cover'>
          <img  className='rounded-t-full rounded-b-full w-full max-w-full h-auto border-solid   border-4  border-gray-500' src={LinkerImage} alt="my_image" />
                </div>
        </div>
        </div>
        <Footer />
