...
const Footer: React.FC = () => {
  return (
    <div className="bg-slate-700 flex flex-col lg:flex-row justify-center items-center lg:gap-20 gap-3  font-bold  mt-8 text-blue-200 ">
      <div>
        <img
          className="rounded-3xl mt-2 w-32 max-w-full h-auto"
          src={Image}
          alt="img"
        />
      </div>
      <div className="flex flex-col gap-2 ">
        ...
        <h3 className="flex">
          <MdDeveloperBoard className="mt-1" />
          Front-end developer
        </h3>
        <h3 className="flex ">
          <CgDesignmodo className="mt-1  " /> UI/UX Designer
        </h3>
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <h3 className="flex">
          <VscCode className="mt-1  " />
          VS Code
        </h3>
        <h3 className="flex">
          <GiTRexSkull className="mt-1  " />
          Git
        </h3>
        <h3 className="flex">
          <FaFigma className="mt-1  " />
          Figma
        </h3>
        <h3 className="flex">
        ...
        <h3 className="flex">
          <RiTailwindCssLine className="mt-1  " />
          Tailwind CSS
        </h3>
        <h3 className="flex">
          <BsBootstrap className="mt-1  " />
          Boostrap
        </h3>
        <h3 className="flex">
          <DiGithub className="mt-1  " />
          Github
        </h3>
        <h3 className="flex">
          <SiMysql className="mt-1  " />
          Mysql
        </h3>
        <h3 className="flex">
          <SiVite className="mt-1  " />
          vite
        </h3>
      </div>
